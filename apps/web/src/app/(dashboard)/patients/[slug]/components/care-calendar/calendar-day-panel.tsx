  ...
  return (
    <>
      <div className="flex flex-col bg-white">
        ...
        <div
          className="divide-y divide-gray-100/80 max-h-[480px] overflow-y-auto overflow-x-hidden [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
        ...
        <div className="pt-3 mt-2 shrink-0 border-t border-gray-100">
          <button
            type="button"
            onClick={onAddTask}
