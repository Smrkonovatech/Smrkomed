  ...
  stages: [
    ...
    // 02. Initial Consultation
    {
      ...
      tasks: [
        ...
        {
          title: "Share pre-consultation preparation guide",
          description: "WhatsApp message with fasting instructions, documents to bring (IDs, previous reports), and partner attendance confirmation.",
          taskType: "PATIENT_TASK",
          ownerRole: "PATIENT",
          priority: "NORMAL",
          dueTimingDays: 0,
          communicationConfig: {
            ...
            whatsapp: {
              enabled: true,
              templateName: "pre_consultation_guide",
              variables: ["patient_name", "appointment_date", "clinic_name"],
              buttons: ["View Checklist", "Need Help"],
            },
          },
          reminderConfig: { remindAtHours: 12, channel: "WHATSAPP" },
          completionCondition: { type: "PATIENT_CONFIRMATION" },
          requiredAction: "ACKNOWLEDGE_PREP_GUIDE",
        },
      ],
    },
    ...
    // 03. Fertility Investigation / Workup
    {
      ...
      tasks: [
        ...
        {
          title: "Hysterosalpingography (HSG) or saline infusion sonography",
          description: "Uterine cavity and tubal patency assessment to rule out tubal blockage or uterine abnormalities.",
          taskType: "APPOINTMENT_TASK",
          ownerRole: "CARE_COORDINATOR",
          priority: "HIGH",
          dueTimingDays: 3,
          communicationConfig: {
            ...
            whatsapp: {
              enabled: true,
              templateName: "hsg_appointment_reminder",
              variables: ["patient_name", "appointment_date", "clinic_name"],
              buttons: ["View Appointment", "Need Help"],
            },
          },
          reminderConfig: { remindAtHours: 12, channel: "WHATSAPP" },
          completionCondition: { type: "APPOINTMENT_COMPLETED" },
          requiredAction: "COMPLETE_HSG",
        },
        {
          title: "Partner infectious disease screening",
          description: "Male partner completes mandatory HIV, HBsAg, HCV, and VDRL blood screening as per ICMR/ART Act guidelines.",
          taskType: "PATIENT_TASK",
          ownerRole: "PATIENT",
          priority: "HIGH",
          dueTimingDays: 3,
          communicationConfig: {
            ...
            whatsapp: {
              enabled: true,
              templateName: "partner_infectious_screen",
              variables: ["patient_name", "clinic_contact"],
              buttons: ["Upload Report", "Book Lab Slot"],
            },
          },
          reminderConfig: { remindAtHours: 24, channel: "WHATSAPP" },
          escalationConfig: { escalateAfterHours: 72, escalateTo: "COORDINATOR", escalationType: "MISSING_REPORT" },
          completionCondition: { type: "REPORT_UPLOADED" },
          requiredAction: "UPLOAD_PARTNER_SCREEN",
        },
      ],
    },
    ...
    // 05. Treatment Planning & Consent
    {
      ...
      tasks: [
        ...
        {
          title: "Insurance / TPA pre-authorization submission",
          description: "If applicable, coordinator submits pre-authorization documents to insurance provider or third-party administrator for IVF coverage approval.",
          taskType: "COORDINATOR_TASK",
          ownerRole: "CARE_COORDINATOR",
          priority: "NORMAL",
          dueTimingDays: 2,
          completionCondition: { type: "STAFF_VERIFICATION" },
          requiredAction: "SUBMIT_PREAUTH",
        },
      ],
    },
    ...
    // 06. Cycle Preparation Checklist
    {
      ...
      tasks: [
        ...
        },
        {
          ...
          description: "Provide guidance on folic acid supplementation, CoQ10, balanced diet, adequate hydration, alcohol/smoking cessation, and stress management during cycle.",
          taskType: "PATIENT_TASK",
          ownerRole: "PATIENT",
          priority: "NORMAL",
          dueTimingDays: 1,
          communicationConfig: {
            ...
            whatsapp: {
              enabled: true,
              templateName: "lifestyle_counseling_guide",
              variables: ["patient_name", "clinic_name"],
              buttons: ["View Guide", "Talk to Team"],
            },
          },
          completionCondition: { type: "PATIENT_CONFIRMATION" },
          requiredAction: "ACKNOWLEDGE_LIFESTYLE_GUIDE",
        },
        {
          title: "Pre-cycle infectious disease re-screen",
          description: "If initial screening was done > 3 months ago, repeat HIV, HBsAg, HCV, VDRL for both partners before cycle start.",
          taskType: "COORDINATOR_TASK",
          ownerRole: "CARE_COORDINATOR",
          priority: "NORMAL",
          dueTimingDays: 1,
          completionCondition: { type: "STAFF_VERIFICATION" },
          requiredAction: "VERIFY_RESCREEN",
        },
      ],
    },
    ...
    // 07. Ovarian Stimulation - Daily Companion
    {
      ...
      tasks: [
        ...
        {
          title: "GnRH antagonist injection initiation",
          description: "For Antagonist Protocol patients: begin daily GnRH antagonist injection (Cetrorelix/Ganirelix) typically on stimulation Day 5-6 to prevent premature ovulation.",
          taskType: "MEDICATION_TASK",
          ownerRole: "PATIENT",
          priority: "HIGH",
          dueTimingDays: 5,
          communicationConfig: {
            ...
            whatsapp: {
              enabled: true,
              templateName: "antagonist_start_reminder",
              variables: ["patient_name", "medication_name", "scheduled_time"],
              buttons: ["I've Taken It", "Need Help"],
            },
          },
          reminderConfig: { remindAtHours: 2, channel: "WHATSAPP" },
          escalationConfig: { escalateAfterHours: 3, escalateTo: "COORDINATOR", escalationType: "TASK_OVERDUE" },
          completionCondition: { type: "PATIENT_CONFIRMATION" },
          requiredAction: "CONFIRM_ANTAGONIST",
        },
        {
          title: "Serum Estradiol blood draw for dose adjustment",
          description: "Intermediate blood E2 level to help doctor optimize gonadotropin dosing and monitor ovarian response.",
          taskType: "PATIENT_TASK",
          ownerRole: "PATIENT",
          priority: "NORMAL",
          dueTimingDays: 4,
          communicationConfig: {
            ...
            whatsapp: {
              enabled: true,
              templateName: "estradiol_blood_draw",
              variables: ["patient_name", "lab_timings"],
              buttons: ["Upload Report", "Need Help"],
            },
          },
          reminderConfig: { remindAtHours: 12, channel: "WHATSAPP" },
          completionCondition: { type: "REPORT_UPLOADED" },
          requiredAction: "UPLOAD_E2_REPORT",
        },
      ],
    },
    ...
    // 09. Trigger Injection - Highest Urgency
    {
      ...
      tasks: [
        ...
        {
          title: "Stop all stimulation medications",
          description: "Critical reminder: stop all gonadotropin (FSH/LH) and antagonist injections immediately after trigger administration. Only take medications specifically prescribed for trigger day.",
          taskType: "MEDICATION_TASK",
          ownerRole: "PATIENT",
          priority: "CLINICAL",
          dueTimingDays: 0,
          communicationConfig: {
            ...
            whatsapp: {
              enabled: true,
              templateName: "stop_stimulation_meds",
              variables: ["patient_name", "clinic_contact"],
              buttons: ["Understood", "Need Help"],
            },
          },
          reminderConfig: { remindAtHours: 1, channel: "WHATSAPP" },
          completionCondition: { type: "PATIENT_CONFIRMATION" },
          requiredAction: "CONFIRM_STIM_STOPPED",
        },
      ],
    },
    {
      ...
      tasks: [
        ...
        {
          title: "Post-OPU recovery care instructions",
          description: "WhatsApp guide: rest for 24 hours, mild cramping/spotting is normal, avoid heavy lifting, report severe pain/bleeding/fever immediately to emergency number.",
          taskType: "PATIENT_TASK",
          ownerRole: "PATIENT",
          priority: "HIGH",
          dueTimingDays: 0,
          communicationConfig: {
            ...
            whatsapp: {
              enabled: true,
              templateName: "post_opu_recovery",
              variables: ["patient_name", "clinic_emergency_number"],
              buttons: ["I'm Fine", "I Have a Concern"],
            },
          },
          reminderConfig: { remindAtHours: 6, channel: "WHATSAPP" },
          completionCondition: { type: "PATIENT_CONFIRMATION" },
          requiredAction: "CONFIRM_RECOVERY_STATUS",
        },
      ],
    },
    ...
    // 11. Embryology & Fertilization
    {
      ...
      tasks: [
        ...
        {
          title: "Day 3 cleavage stage embryo report",
          description: "Intermediate embryo development update at Day 3: cell count, fragmentation grade, and development trajectory.",
          taskType: "REPORT_TASK",
          ownerRole: "STAFF",
          priority: "HIGH",
          dueTimingDays: 3,
    ...
    // 12. Embryo Transfer / FET
    {
      ...
      tasks: [
        ...
        {
          title: "Post-transfer rest and activity guidelines",
          description: "WhatsApp guide: avoid strenuous activity for 48 hours, no heavy lifting, no hot baths/sauna, travel guidance, and when to contact the clinic.",
          taskType: "PATIENT_TASK",
          ownerRole: "PATIENT",
          priority: "NORMAL",
          dueTimingDays: 0,
          communicationConfig: {
            ...
            whatsapp: {
              enabled: true,
              templateName: "post_transfer_guidelines",
              variables: ["patient_name", "clinic_contact"],
              buttons: ["View Guidelines", "Talk to Team"],
            },
          },
          completionCondition: { type: "PATIENT_CONFIRMATION" },
          requiredAction: "ACKNOWLEDGE_TRANSFER_GUIDE",
        },
      ],
    },
    ...
    // 13. Post-Transfer Support
    {
      ...
      tasks: [
        ...
        {
          title: "Day 7 mid-wait emotional check-in",
          description: "Midpoint emotional support and medication adherence check during the 2-week wait. Reassure patient and confirm progesterone compliance.",
          taskType: "PATIENT_TASK",
          ownerRole: "PATIENT",
          priority: "NORMAL",
          dueTimingDays: 7,
        ...
        {
          title: "Day 10 pre-test preparation reminder",
          description: "Advance notice that Beta-hCG blood test is approaching in 4 days. Confirm lab appointment and prepare emotionally.",
          taskType: "PATIENT_TASK",
          ownerRole: "PATIENT",
          priority: "NORMAL",
          dueTimingDays: 10,
          communicationConfig: {
            ...
            whatsapp: {
              enabled: true,
              templateName: "pre_betahcg_reminder",
              variables: ["patient_name", "test_date", "clinic_contact"],
              buttons: ["View Instructions", "Talk to Team"],
            },
          },
          reminderConfig: { remindAtHours: 24, channel: "WHATSAPP" },
          completionCondition: { type: "PATIENT_CONFIRMATION" },
    ...
    // 14. Beta-hCG / Pregnancy Test
    {
      ...
      tasks: [
        ...
        {
          title: "Repeat Beta-hCG at 48 hours",
          description: "If initial Beta-hCG is positive, schedule repeat quantitative test at 48 hours to confirm doubling-time trajectory.",
          taskType: "PATIENT_TASK",
          ownerRole: "PATIENT",
          priority: "HIGH",
          dueTimingDays: 16,
          communicationConfig: {
            ...
            whatsapp: {
              enabled: true,
              templateName: "repeat_betahcg_reminder",
              variables: ["patient_name", "test_date", "clinic_contact"],
              buttons: ["Upload Report", "Need Help"],
            },
          },
          reminderConfig: { remindAtHours: 12, channel: "WHATSAPP" },
          completionCondition: { type: "REPORT_UPLOADED" },
          requiredAction: "UPLOAD_REPEAT_BETAHCG",
        },
      ],
    },
