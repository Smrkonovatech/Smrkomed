...
protectedRoutes.route("/treatments", treatmentRoutes);
...
protectedRoutes.route("/diagnostics", diagnosticRoutes);
protectedRoutes.route("/clinical-diagnostics", diagnosticRoutes);
