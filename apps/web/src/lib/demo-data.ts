...
export const couples: Couple[] = [
  ...
  {
    id: "cmt35xw2t0005pa10zjeatwlv",
    slug: "mohit-shru",
    primary: { name: "Mohit", age: 34, phone: "+91 78922 65880" },
    partner: { name: "Shru", age: 31, phone: "+91 98450 11333" },
    treatment: "IVF",
    cycleLabel: "IVF Intake",
    stageIndex: 1,
    cycle: "Cycle 01",
    ...
    coordinator: "Meera Iyer",
    careLoop: "Active",
    nextStep: "Initial Consultation tomorrow at 10:00 AM",
    status: "On Track",
    tags: ["IVF", "Consultation", "WhatsApp Active"],
    since: "21 Aug 2026",
  },
  {
    id: "c1",
