  ...
  },
  {
    ...
    definition: {
      nodes: [
        ...
        {
          id: "n_welcome_existing",
          type: "SEND_TEXT",
          label: "Welcome Existing Patient",
          config: {
            body: "Welcome back, {{patient.firstName}}! 👋\n\nI found your patient profile. Let's find the right doctor and appointment time for you:",
          },
        ...
        },
        {
          ...
          config: {
            body: "Welcome to {{clinic.name}}! 👋\n\nI'll help you book your appointment. What is your full name?",
            waitForReply: true,
          },
        ...
        },
        {
          id: "n_ask_couple",
          type: "SEND_BUTTONS",
          label: "Ask Consultation Type",
          config: {
            body: "Thanks, {{patient_name}}! 😊\n\nAre you booking this consultation for yourself or as a couple?",
            buttons: [
              { id: "appt_reg_myself", title: "Myself 👤" },
              { id: "appt_reg_couple", title: "As a Couple 👥" },
            ],
            waitForReply: true,
          },
        ...
        },
        {
          id: "n_welcome_new",
          type: "SEND_TEXT",
          label: "Welcome New Patient",
          config: {
            body: "Profile created! ✨ Let's choose the right doctor for your consultation:",
          },
        ...
        },
        {
          id: "n_no_slots_msg",
          type: "SEND_TEXT",
          label: "No Slots Notice",
          config: {
            body: "There are no available appointments for this date 📅\n\nPlease choose another date:",
          },
        ...
        {
          id: "n_slot_expired_msg",
          type: "SEND_TEXT",
          label: "Slot Unavailable Notice",
          config: {
            body: "That time is no longer available ⏰\n\nPlease choose another slot:",
          },
          position: { x: 450, y: 1720 },
        },
        {
          id: "n_task",
          type: "CREATE_TASK",
        ...
        },
        {
          ...
          config: {
            ...
            message: "I couldn't complete that step automatically. I've connected you with our clinic team, and they'll help you with the appointment shortly.",
          },
      ...
      edges: [
        ...
        { id: "e2", source: "n_detect_intent", target: "n_patient_lookup", branch: "appointment" },
        { id: "e2_other", source: "n_detect_intent", target: "node_end", branch: "not_appointment" },
        { id: "e_lookup_existing", source: "n_patient_lookup", target: "n_welcome_existing", branch: "existing_patient" },
        { id: "e_lookup_new", source: "n_patient_lookup", target: "n_ask_name", branch: "new_patient" },
        { id: "e_welcome_exist_doc", source: "n_welcome_existing", target: "n_get_doctors" },
        { id: "e_ask_name_couple", source: "n_ask_name", target: "n_ask_couple" },
        { id: "e_ask_couple_create", source: "n_ask_couple", target: "n_create_patient" },
        { id: "e_create_welcome", source: "n_create_patient", target: "n_welcome_new" },
        { id: "e_welcome_new_doc", source: "n_welcome_new", target: "n_get_doctors" },
        ...
        { id: "e7_other", source: "n_show_details", target: "n_show_doctors", branch: "btn_other_doc" },
        { id: "e7_slots", source: "n_show_details", target: "n_get_dates", branch: "btn_see_slots" },
        ...
        { id: "e10_noslots", source: "n_get_slots", target: "n_no_slots_msg", branch: "no_slots" },
        { id: "e10_retry_dates", source: "n_no_slots_msg", target: "n_show_dates" },
        { id: "e11", source: "n_show_slots", target: "n_summary" },
        { id: "e12", source: "n_summary", target: "n_confirm" },
        { id: "e13", source: "n_confirm", target: "n_book" },
        { id: "e13_confirm", source: "n_confirm", target: "n_book", branch: "appt_confirm" },
        { id: "e13_change", source: "n_confirm", target: "n_get_dates", branch: "appt_change_time" },
        { id: "e13_cancel", source: "n_confirm", target: "node_end", branch: "appt_cancel" },
        { id: "e14", source: "n_book", target: "n_task" },
        { id: "e14_expired", source: "n_book", target: "n_slot_expired_msg", branch: "slot_expired" },
        { id: "e14_retry_slots", source: "n_slot_expired_msg", target: "n_show_slots" },
