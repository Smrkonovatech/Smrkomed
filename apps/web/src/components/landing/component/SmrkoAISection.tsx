  ...
  return (
    <section className="relative w-full bg-white py-24 sm:py-32 overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-12">
        {/* Main Blue Card */}
        <div className="relative w-full rounded-[40px] bg-gradient-to-br from-[#77D0F1] to-[#9CDDF4] h-[750px] lg:h-[650px] flex flex-col lg:flex-row items-center justify-end px-8 lg:px-20 py-12 lg:py-0 shadow-lg">
          
          {/* Lady Image Background */}
          <div className="absolute left-[-8%] lg:left-[2%] bottom-0 w-[95%] lg:w-[65%] max-w-[700px] z-0 pointer-events-none">
            <Image 
          ...
          <div className="absolute top-[8%] lg:top-[15%] left-[2%] lg:left-[5%] z-20 w-[260px] lg:w-[280px] bg-white/95 backdrop-blur-xl border border-white/50 shadow-[0_20px_40px_rgba(0,0,0,0.06)] rounded-3xl p-6">
          ...
          <div className="absolute top-[48%] lg:top-[50%] left-[-8%] lg:left-[-5%] z-20 flex items-center gap-3 bg-white shadow-[0_15px_30px_rgba(0,0,0,0.06)] rounded-full py-2.5 px-3 pr-6">
          ...
          <div className="absolute bottom-[2%] lg:bottom-[8%] left-[5%] lg:left-[15%] z-20 w-[280px] lg:w-[310px] bg-white/95 backdrop-blur-xl border border-white/50 shadow-[0_20px_40px_rgba(0,0,0,0.06)] rounded-[28px] p-6 pb-8">
          ...
          <div className="relative z-30 w-full lg:w-[45%] flex flex-col items-center lg:items-start text-center lg:text-left mt-8 lg:mt-[-40px] lg:mr-[2%]">
            ...
            <h2 className="text-[3rem] lg:text-[4.8rem] leading-[1.05] text-[#1E293B] font-normal tracking-tight mb-6">
