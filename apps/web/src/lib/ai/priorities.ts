    ...
    if (hours >= 0 && hours <= 2) {
      items.push({
        ...
        detail: appt.coupleLabel
          ? `${appt.coupleLabel} · ${appt.startsAt.toLocaleTimeString("en-IN", { timeZone: "Asia/Kolkata", hour: "numeric", minute: "2-digit" })}`
          : appt.startsAt.toLocaleTimeString("en-IN", { timeZone: "Asia/Kolkata", hour: "numeric", minute: "2-digit" }),
        href: "/appointments",
