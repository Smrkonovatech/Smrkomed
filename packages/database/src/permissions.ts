...
export const PERMISSIONS = {
  ...
  PAYMENTS_GATEWAY_MANAGE: "payments:gateway:manage",
  WHATSAPP_VIEW: "whatsapp:view",
  WHATSAPP_SEND: "whatsapp:send",
  WHATSAPP_FLOWS: "whatsapp:flows",
  WHATSAPP_TEMPLATES: "whatsapp:templates",
  WHATSAPP_KB: "whatsapp:kb",
  WHATSAPP_LOGS: "whatsapp:logs",
  WHATSAPP_SETTINGS: "whatsapp:settings",
  DIGITAL_HEALTH_VIEW: "digital_health:view",
  DIGITAL_HEALTH_MANAGE: "digital_health:manage",
  ABHA_LINK: "abha:link",
...
const PAYMENTS_STAFF = [
  PERMISSIONS.PAYMENTS_VIEW,
  PERMISSIONS.PAYMENTS_CREATE,
  PERMISSIONS.PAYMENTS_LINK,
] as const;

const WHATSAPP_STAFF = [
  PERMISSIONS.WHATSAPP_VIEW,
  PERMISSIONS.WHATSAPP_SEND,
  PERMISSIONS.WHATSAPP_FLOWS,
  PERMISSIONS.WHATSAPP_TEMPLATES,
  PERMISSIONS.WHATSAPP_KB,
  PERMISSIONS.WHATSAPP_LOGS,
] as const;

const DIGITAL_HEALTH_CLINICAL = [
  PERMISSIONS.DIGITAL_HEALTH_VIEW,
  PERMISSIONS.ABHA_LINK,
  PERMISSIONS.ABHA_VERIFY,
  PERMISSIONS.CONSENT_VIEW,
  PERMISSIONS.CONSENT_MANAGE,
  PERMISSIONS.RECORD_SHARE,
  PERMISSIONS.RECORD_EXPORT,
] as const;

const DIGITAL_HEALTH_COORD = [
  PERMISSIONS.DIGITAL_HEALTH_VIEW,
  PERMISSIONS.ABHA_LINK,
  PERMISSIONS.ABHA_VERIFY,
  PERMISSIONS.CONSENT_VIEW,
